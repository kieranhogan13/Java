...
import ie.kieranhogan.simpleinstagramapp.ApplicationData;
import ie.kieranhogan.simpleinstagramapp.MainActivity;
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    MainActivity.jsonObject = (JSONObject) new JSONTokener(response).nextValue();
