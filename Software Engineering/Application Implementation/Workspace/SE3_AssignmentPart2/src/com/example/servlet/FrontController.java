...
public class FrontController extends HttpServlet {
	...
	private static final String PASSWORD_ACTION = "ChangePassword";  
	private static final String CHANGED_ACTION = "ChangedPasswordResult";  
    /**
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response) {
		...
		if ( action.equalsIgnoreCase(PASSWORD_ACTION) )
		{
		...
		if ( action.equalsIgnoreCase(CHANGED_ACTION) )
		{
